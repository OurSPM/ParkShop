...
def register(request):
	...
	if request.method == "POST":
		...
		if cf.is_valid():
			...
			if cf.cleaned_data['identity'] == 'C':
				...
				#write into db
				customer_href="http://10.170.63.214:8000/verification/"+randomCode+"/c/"+customer.CustomerEmail
    ...
    [customer.CustomerEmail], fail_silently=False)
			...
			#返回注册成功页面
				...
				#write into db
				customer_href="http://10.170.63.214:8000/verification/"+randomCode+"/s/"+seller.SellerEmail
				# message=<a href=customer_href>Click the link to verifivation!</a>
				send_mail(u'parknshop confirm', customer_href, '2473490238@qq.com',
