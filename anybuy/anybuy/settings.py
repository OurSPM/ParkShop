"""
Django settings for anybuy project.
...
SECRET_KEY = '3ty8s9(z$1(icpc96@cu7(h1y+@2^3o6e&$@b=9k9#ks)wg+p('
...
ROOT_URLCONF = 'anybuy.urls'

WSGI_APPLICATION = 'anybuy.wsgi.application'
